...
export function createProjectAreaData(): { areas: ProjectArea[]; testCases: Record<string, Omit<TestCasesProjectState, 'areas'>>; requirements: Record<string, Omit<RequirementsProjectState, 'areas'>>; audit: Record<string, AuditItem[]> } {
