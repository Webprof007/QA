...
type Props = { initial: SmokeSuiteInput; code: string; cases: TestCase[]; areas: ProjectArea[]; types: TestCaseDictionaryValue[]; onSave: (input: SmokeSuiteInput) => string | null; onCancel: () => void }
