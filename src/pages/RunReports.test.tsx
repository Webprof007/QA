...
describe('Run Reports UI', () => {
  it('renders Test Run report from existing results and returns to the selected execution', async () => {
    ...
    click('Next'); change('Result', 'Fail'); click('Save result'); click('Create Defect'); click('Save Defect')
    click('View Report')
  ...
  it('renders Smoke report with prerequisites, empty/not-run totals and source snapshot rows', async () => {
    ...
    click('Back to Run'); change('Prerequisite result 1', 'Pass'); click('TC-001'); change('Result', 'Fail'); click('Save result'); click('Create Defect'); click('Save Defect')
