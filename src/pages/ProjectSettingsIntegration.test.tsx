...
function Harness({ protectedArea = false }: { protectedArea?: boolean }) {
  const [areas, setAreas] = useState<ProjectArea[]>([{ id: '10', projectId: '1', name: 'Authentication' }, { id: '20', projectId: '2', name: 'Foreign Area' }])
  const [types, setTypes] = useState<TestCaseDictionaryValue[]>([{ id: '30', projectId: '1', name: 'Functional' }, { id: '40', projectId: '2', name: 'Foreign Type' }])
  ...
  return <ProjectSettingsPage project={project} areas={areas} types={types} data={setup} onChange={setSetup}
